...
\label{sec:test}
    ...
    \begin{table}[!t]
        ...
        \begin{tabular}{|l|c|c|c||c|c|c|}\hline
             & {\bfseries Kappa of}      & {\bfseries Kappa of}     & {\bfseries Kappa of}     & {\bfseries Training} & {\bfseries Classif.} & {\bfseries \# features} \\
             & {\bfseries 5\_11 (train)} & {\bfseries 5\_12 (test)} & {\bfseries 3\_10 (test)} & {\bfseries time (s)} & {\bfseries time (s)} & {\bfseries to classify} \\
            \hline
    ...
    \begin{table}[!t]
        ...
        \begin{tabular}{|l|c|c|c||c|c|c|}\hline
             & {\bfseries Kappa of}      & {\bfseries Kappa of}     & {\bfseries Kappa of}     & {\bfseries Training} & {\bfseries Classif.} & {\bfseries \# features} \\
             & {\bfseries 5\_11 (train)} & {\bfseries 5\_12 (test)} & {\bfseries 3\_10 (test)} & {\bfseries time (s)} & {\bfseries time (s)} & {\bfseries to classify} \\ \hline
