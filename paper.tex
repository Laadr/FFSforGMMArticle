...
referred to  \emph{feature construction}.   Linear combination  of the
...
as the  most relevant  by a  given criterion.   It has  the additional
advantage to be much more easily understandable for the end-user.
...
The remaining of the article is organized as follows. Section~\ref{sec:gmm-hd} presents GMM classifiers and the problems related to high-dimensional feature space. The features selection methods are detailed in Section~\ref{sec:selection}. Then an efficient implementation of the proposed selection method is presented in Section~\ref{sec:implementation}. Experimental results on two real high dimensional data set are given Section~\ref{sec:test}. Conclusion and perspectives conclude the paper in Section~\ref{sec:conclusion}.
...
\subsection{Statistical update rules}
    ...
    given      from~\ref{tab:crit}.       The      second,      called
...
\label{sec:test}
    ...
    of classification accuracy and processing time.
