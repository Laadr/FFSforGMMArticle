...
\label{sec:test}
    ...
    of variables corresponding to the  highest value oft he criterion,
    ...
    derivative of the criteria. See  %%TODO: faire une figure avec une
                                    %%courbe réelle et montrer où l'on
                                    %%s'arrete et où est le max.
