...
The feature selection method proposed in this work is a wrapper method associated to GMM models. To set up a wrapper method, two elements are needed. A function that  ranks the features according to some criteria and a search strategy to optimize the function. The criterion used are described in Section~\ref{sec:criterion} and the two search strategy are discussed in~\ref{sec:selection:method}.
